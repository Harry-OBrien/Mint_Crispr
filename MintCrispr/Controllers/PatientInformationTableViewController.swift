...
class PatientInformationTableViewController: UITableViewController {
	...
	override func viewDidLoad() {
		...
		tableView.register(PatientCollectionViewCell.self, forCellReuseIdentifier: PatientCollectionViewCell.reuseIdentifier)
	}
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cell = tableView.dequeueReusableCell(withIdentifier: PatientCollectionViewCell.reuseIdentifier, for: indexPath)
